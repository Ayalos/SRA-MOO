 ...
 * @author klebson
 */
public class Tela_Diretor  extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/view/Tela_Diretor.fxml")); // CARREGANDO FXML
        
        Scene scene = new Scene(root); // COLOCANDO FXML NA CENA 
        stage.setTitle("Diretor - SRA"); // COLOCANDO UM TITULO 
